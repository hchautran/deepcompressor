...
@configclass
@dataclass
class SamGPTQConfig(SkipBasedConfig, QuantGptqConfig):
    """Configuration for SAM GPTQ quantization.
...
@configclass
@dataclass
class SamQuantizerConfig(QuantizerConfig):
    """SAM model quantizer configuration.
    ...
    Args:
        ...
        kernel_gptq (`SamGPTQConfig` or `None`, *optional*, defaults to `None`):
    ...
    static: bool = False
    kernel_gptq: SamGPTQConfig | None = None
...
@configclass
@dataclass
class SamWeightQuantizerConfig(SamQuantizerConfig):
    """SAM weight quantizer configuration.
...
@configclass
@dataclass
class SamActivationQuantizerConfig(SamQuantizerConfig):
    """SAM activation quantizer configuration.
...
@configclass
@dataclass
class SamModuleQuantizerConfig(EnableConfig):
    """SAM module quantizer configuration combining weights and activations.
