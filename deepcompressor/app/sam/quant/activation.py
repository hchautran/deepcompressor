# -*- coding: utf-8 -*-
"""SAM activation quantization utilities."""
...
from .quantizer import SamActivationQuantizer
...
def calibrate_sam_activations(
    ...
    quantizers: dict[str, SamActivationQuantizer],
    calib_loader: tp.Iterable,
    num_samples: int = 128,
) -> dict[str, tp.Any]:
    """Calibrate SAM activation quantizers.
    ...
    logger.info("Calibrating SAM activations...")
...
def quantize_sam_activations(
    ...
    """Apply activation quantizers to SAM model.
