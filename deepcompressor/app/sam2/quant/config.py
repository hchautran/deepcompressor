...
from ..dataset.calib import Sam2CalibCacheLoaderConfig
...
class Sam2QuantConfig(Sam2ModuleQuantizerConfig):
    ...
    calib: Sam2CalibCacheLoaderConfig
    rotation: QuantRotationConfig = None
    smooth: SmoothTransfomerConfig = None
    ...
    ) -> Sam2QuantCacheConfig:  # noqa: C901
